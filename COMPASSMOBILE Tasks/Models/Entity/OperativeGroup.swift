//
//  OperativeGroup.swift
//  COMPASSMOBILE
//
//  Created by Andrew Harper on 29/05/2019.
//  Copyright © 2019 HYDOP E.C.S. All rights reserved.
//

import AEXML

class OperativeGroup: NSObject {
    ...
    convenience
    init(rowId:String, createdBy: String, createdOn: Date, lastUpdatedBy: String?, lastUpdatedOn: Date?, deleted: Date?, OrganisationId: String, name: String) {
        self.init()
        self.RowId = rowId
