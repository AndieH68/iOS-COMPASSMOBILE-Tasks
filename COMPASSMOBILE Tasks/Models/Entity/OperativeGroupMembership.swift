...
class OperativeGroupMembership: NSObject {
    ...
    var OperativeId: String = String()
    
    // MARK: - Contructors
    
    convenience
    init(rowId:String, createdBy: String, createdOn: Date, lastUpdatedBy: String?, lastUpdatedOn: Date?, deleted: Date?, OperativeGroupId: String, OperativeId: String) {
        self.init()
        self.RowId = rowId
