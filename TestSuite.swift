...
class TestSuite: NSObject {
    ...
    var TestSuiteType: String = String()
    var FlushType: String? = nil
    
    // MARK: - Contructors
    
    convenience
    init(rowId: String, createdBy: String, createdOn: Date, lastUpdatedBy: String?, lastUpdatedOn: Date?, deleted: Date?, organisationId: String, name: String, description: String, testSuiteType: String, flushType: String?) {
        self.init()
        self.RowId = rowId
        ...
        self.TestSuiteType = testSuiteType
    ...
    init(XMLElement: AEXMLElement) {
        ...
        self.TestSuiteType = XMLElement.attributes["Type"]!
